...
void caseOne() {
    ...
    while (!stop) {
        ...
        double firstMovement, secondMovement, position;
        ...
        cout << YELLOW "Final displacement: " << GREEN << firstMovement + secondMovement << measurement << ", " << direction << RESET;
        cin.get();
...
int main()
{
    ...
    cout << GREEN << "WELCOME TO ILAIDA's COPH PROGRAM" << RESET;
